...
{
    #[Test]
    public function it_has_exactly_the_four_documented_counters(): void
    {
        ...
        self::assertCount(4, BalanceCounter::cases());
    }
    ...
    public function its_backing_values_are_stable_for_persistence(): void
    {
        ...
        self::assertSame('variable', BalanceCounter::Variable->value);
